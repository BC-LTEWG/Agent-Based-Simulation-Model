...
double Distributor::take_from_old_projects(Good * good, double remaining) {
    auto old_projects = this->old_projects(good);
...
void Distributor::take_from_new_projects(Good * good, double remaining) {
