    ...
    health_status(HEALTHY)
{
    ...
    double ability_std_dev = Sim::get_ability_stddev();
    std::lognormal_distribution<>
        ability_dist(-0.5 * ability_std_dev * ability_std_dev, ability_std_dev);
    ...
    log_account();
    busyness = Sim::get_consumption_difficulties()[0];
}
