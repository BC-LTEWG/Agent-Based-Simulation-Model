...
This sub-project converts labor hours to money by using MELT, which comes from dividing one of the three below values by average hours worked per year. 
The four values include
- GDP Nominal
- GDP PPP
- Mean Income
