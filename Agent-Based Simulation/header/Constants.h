...
const double AVERAGE_RETIREMENT_AGE = (1 - pow(1 - RANDOM_RETIREMENT_CHANCE, GUARANTEED_RETIREMENT_AGE)) /
...
const int PRODUCT_NUM_INPUTS_MAX = NUM_BASE_PRODUCTS;
...
const int FIRM_STOCKPILE_DURATION = WEEK;
