...
const int FIRM_REORDER_ATTEMPTS = 20;
const double REASONABLE_INPUT_CONSUMPTION_PROP = 0.1;
const double PRODUCER_INITIAL_INVENTORY_MULT = 2;
const double DISTRIBUTOR_INITIAL_INVENTORY_MULT = 1;
const double DEADLINE_SAFETY_MULT = 0.8;
