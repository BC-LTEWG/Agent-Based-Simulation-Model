...
const int STARTING_NUM_PRODUCTS = 10;
...
const int PRODUCT_ORDER_SIZE_MAX = 100;
const int PRODUCT_NUM_INPUTS_MIN = 0;
const int PRODUCT_NUM_INPUTS_MAX = 2;
...
const int PRODUCT_NUM_MACHINES_MAX = 1;
...
const double PRODUCT_CONSUMPTION_FREQUENCY_MAX = 1.0 / DAY;
...
const double FIRM_INITIAL_INVENTORY_MULTIPLIER = 1;
