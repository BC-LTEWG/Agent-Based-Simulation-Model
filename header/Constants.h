...
const double DESIRED_WORK_HOUR_RATIO = 0.7;
const double WORK_HOUR_WINDOW_RADIUS = 0.05;
const int WORK_WEEK_ADJUSTMENT_START  = MONTH;
...
const int MACHINE_LIFETIME_MAX = MACHINE_LIFETIME_MIN * 4;
const int MACHINE_SCALE_MULTIPLIER = 700;
const double INITIAL_MACHINE_AGE_MIN_PROP = 0.4;

const int FIRM_STOCKPILE_DURATION = 1.5 * WEEK;
const double FIRM_STOCKPILE_MINIMUM = 2.0;

const double FIRM_REORDER_MAX_PROP = 0.5;
const double FIRM_REORDER_URGENCY = 0.05;
const int DISTRIBUTOR_DEMAND_AVERAGING_WINDOW = 2*WEEK;
const int PRODUCER_DEMAND_AVERAGING_WINDOW = 4*MONTH;
const int BUSYNESS_AVERAGING_WINDOW = WEEK;
const double TRANSFER_BUSYNESS_THRESHOLD = 0.07;
...
const double ABILITY_STDDEV = 0.1;
