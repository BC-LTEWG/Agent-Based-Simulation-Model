...
const int PRODUCT_NUM_INPUTS_MAX = STARTING_NUM_GOODS / 2;
const double PRODUCT_INPUT_PER_UNIT_MIN = 0.1;
const double PRODUCT_INPUT_PER_UNIT_MAX = 1.0;
const double DEGREE_OF_PRODUCTIVITY = 0.25;
...
const double DISTRIBUTION_LABOR_PER_UNIT = 0.05;
const double PRODUCT_CONSUMPTION_MULT = 0.6;
