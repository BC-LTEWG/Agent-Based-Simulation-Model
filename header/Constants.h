...
const int PRODUCT_NUM_INPUTS_MAX = 50;
const int PRODUCT_NUM_INPUT_MACHINES_MIN = 0;
const int PRODUCT_NUM_INPUT_MACHINES_MAX = 1;
const double PRODUCT_INPUT_AMOUNT_MIN = 1.0;
const double PRODUCT_INPUT_AMOUNT_MAX = 5.0;
...
const int MACHINE_LIFETIME_MIN = 1;
const int MACHINE_LIFETIME_MAX = 1;
const int MACHINE_LABOR_MULT = 10;

const int FIRM_STOCKPILE_DURATION = 2 * WEEK;
const double FIRM_REORDER_DEADLINE_PROP = 0.25;
const double FIRM_REORDER_URGENCY = 0.05;
const int CONSUMER_DEMAND_AVERAGING_WINDOW = 2 * WEEK;
const int REPRODUCTION_DEMAND_AVERAGING_WINDOW = 4 * MONTH;
